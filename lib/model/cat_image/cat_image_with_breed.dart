...
import 'weight.dart';
part 'cat_image_with_breed.g.dart';
@JsonSerializable()
@entity
class CatImageWithBreed {
  Weight? weight;
  @primaryKey
  String? id;
  String? url;
